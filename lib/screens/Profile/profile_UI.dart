...
import 'package:flutter_project/screens/Settings/settings_UI.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          //children: [Icon(Icons.person), SizedBox(width: 10), Text('Profile')],
        ),
        /*actions: [
          IconButton(
            icon: Icon(
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              //buildTextField("Subjects", currentUser.subjects, true),
              SizedBox(
                height: 35,
              ),
              Row(
